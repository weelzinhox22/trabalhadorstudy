...
const Index = () => {
  const [showSinanInfo, setShowSinanInfo] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Botão grande para alternar entre as seções */}
        <div className="mb-8 flex justify-center">
          <Button 
            onClick={() => setShowSinanInfo(!showSinanInfo)}
            className="w-full max-w-2xl py-6 text-xl bg-health-600 hover:bg-health-700 flex items-center justify-center gap-3"
          >
            {showSinanInfo ? (
              <>
        ...
        {/* Botão para o Quiz, visível em ambas as seções */}
...
// Componente SinanInfo para compatibilidade com rotas existentes
const SinanInfo = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <NavBar />
